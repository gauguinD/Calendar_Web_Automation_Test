...
public class suite_05_할일_할일쓰기_Test extends Testcase {
    ...
    */
    ...
    public void TC_02_할일쓰기_할일쓰기_Test() throws Exception {
        ...
        util.type(By.xpath("//div[@class='input_txt']/input"),"할일 쓰기");
        ...
        util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'할일 쓰기')]"));
        taskId = util.waitForIsElementPresent(By.xpath("//li[contains(@class,'task') and ./div/p/a[contains(text(),'할일 쓰기')]]")).getAttribute("id");
        assertTrue(util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'할일 쓰기')]")).isDisplayed());
    ...
    */
    ...
    public void TC_03_할일쓰기_중요할일쓰기_Test() throws Exception {
        ...
        //중요 할일 쓰기 생성
        util.type(By.xpath("//div[@class='input_txt']/input"),"중요 할일 쓰기");
        ...
        util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'중요 할일 쓰기')]"));
        taskId = util.waitForIsElementPresent(By.xpath("//li[contains(@class,'task') and ./div/p/a[contains(text(),'중요 할일 쓰기')]]")).getAttribute("id");
        assertTrue(util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'중요 할일 쓰기')]")).isDisplayed());
    ...
    */
    ...
    public void TC_04_할일쓰기_그룹선택할일쓰기_Test() throws Exception {
        ...
        util.type(By.xpath("//div[@class='input_txt']/input"),"그룹선택 할일 쓰기");
        ...
        //빠른 할일 쓰기라는 제목을 가진 할 일 노출 되는것 확인
        util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'그룹선택 할일 쓰기')]"));
        taskId = util.waitForIsElementPresent(By.xpath("//li[contains(@class,'task') and ./div/p/a[contains(text(),'그룹선택 할일 쓰기')]]")).getAttribute("id");
        assertTrue(util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'그룹선택 할일 쓰기')]")).isDisplayed());
    ...
    */
    ...
    public void TC_05_할일쓰기_완료일할일쓰기_Test() throws Exception {
        ...
        util.type(By.xpath("//div[@class='input_txt']/input"),"완료일 할일 쓰기");
        ...
        //할일 쓰기라는 제목을 가진 할 일 노출 되는것 확인
        util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'완료일 할일 쓰기')]"));
        taskId = util.waitForIsElementPresent(By.xpath("//li[contains(@class,'task') and ./div/p/a[contains(text(),'완료일 할일 쓰기')]]")).getAttribute("id");
        assertTrue(util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'완료일 할일 쓰기')]")).isDisplayed());
    ...
    */
    ...
    public void TC_06_할일쓰기_반복할일쓰기_Test()throws Exception {
        ...
        util.type(By.xpath("//div[@class='input_txt']/input"),"반복 할일 쓰기");
        ...
        //할일 쓰기라는 제목을 가진 할 일 노출 되는것 확인
        util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'반복 할일 쓰기')]"));
        taskId = util.waitForIsElementPresent(By.xpath("//li[contains(@class,'task') and ./div/p/a[contains(text(),'반복 할일 쓰기')]]")).getAttribute("id");
        assertTrue(util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'반복 할일 쓰기')]")).isDisplayed());
    ...
    */
    ...
    public void TC_07_할일쓰기_시작전할일쓰기_Test() throws Exception {
        ...
        util.type(By.xpath("//div[@class='input_txt']/input"), "시작전 할일 쓰기");
        ...
        //할일 쓰기라는 제목을 가진 할 일 노출 되는것 확인
        util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'시작전 할일 쓰기')]"));
        taskId = util.waitForIsElementPresent(By.xpath("//li[contains(@class,'task') and ./div/p/a[contains(text(),'시작전 할일 쓰기')]]")).getAttribute("id");
        assertTrue(util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'시작전 할일 쓰기')]")).isDisplayed());
    ...
    */
    ...
    public void TC_08_할일쓰기_진행중할일쓰기_Test() throws Exception {
        ...
        util.type(By.xpath("//div[@class='input_txt']/input"), "진행중 할일 쓰기");
        ...
        //할일 쓰기라는 제목을 가진 할 일 노출 되는것 확인
        util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'진행중 할일 쓰기')]"));
        taskId = util.waitForIsElementPresent(By.xpath("//li[contains(@class,'task') and ./div/p/a[contains(text(),'진행중 할일 쓰기')]]")).getAttribute("id");
        assertTrue(util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'진행중 할일 쓰기')]")).isDisplayed());
    ...
    */
    ...
    public void TC_09_할일쓰기_완료할일쓰기_Test() throws Exception {
        ...
        util.type(By.xpath("//div[@class='input_txt']/input"), "완료 할일 쓰기");
        ...
        //할일 쓰기라는 제목을 가진 할 일 노출 되는것 확인
        util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'완료 할일 쓰기')]"));
        taskId = util.waitForIsElementPresent(By.xpath("//li[contains(@class,'task') and ./div/p/a[contains(text(),'완료 할일 쓰기')]]")).getAttribute("id");
        assertTrue(util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'완료 할일 쓰기')]")).isDisplayed());
    ...
    */
    ...
    public void TC_10_할일쓰기_알림할일쓰기_Test() throws Exception {
        ...
        util.type(By.xpath("//div[@class='input_txt']/input"),"알림 할일 쓰기");
        ...
        //할일 쓰기라는 제목을 가진 할 일 노출 되는것 확인
        util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'알림 할일 쓰기')]"));
        taskId = util.waitForIsElementPresent(By.xpath("//li[contains(@class,'task') and ./div/p/a[contains(text(),'알림 할일 쓰기')]]")).getAttribute("id");
        assertTrue(util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'알림 할일 쓰기')]")).isDisplayed());
    ...
    */
    ...
    public void TC_11_할일쓰기_설명할일쓰기_Test() throws Exception {
        ...
        util.type(By.xpath("//div[@class='input_txt']/input"),"설명 할일 쓰기");
        ...
        //할일 쓰기라는 제목을 가진 할 일 노출 되는것 확인
        util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'설명 할일 쓰기')]"));
        taskId = util.waitForIsElementPresent(By.xpath("//li[contains(@class,'task') and ./div/p/a[contains(text(),'설명 할일 쓰기')]]")).getAttribute("id");
        assertTrue(util.waitForIsElementPresent(By.xpath("//a[contains(@class,'_content') and contains(text(),'설명 할일 쓰기')]")).isDisplayed());
